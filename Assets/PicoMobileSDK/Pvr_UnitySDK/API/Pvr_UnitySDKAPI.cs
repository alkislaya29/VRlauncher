...
namespace Pvr_UnitySDKAPI
{
    ...
    public struct Render
    {
        ...
        // 2D Overlay
        [DllImport(LibFileName, CallingConvention = CallingConvention.Cdecl)]
        private static extern void Pvr_SetOverlayModelViewMatrix(int texId, int eye, int program,
...
//        }
        ...
        public static void UPvr_SetOverlayModelViewMatrix(int texId, int eye, int program, Matrix4x4 MV)
        {
#if ANDROID_DEVICE
            Pvr_SetOverlayModelViewMatrix(texId, eye, program,
    ...
    public struct System
    {
        ...
        private const string UnitySDKVersion = "2.7.8.8";
